...
def main():
    ...
    t.toggle_show_cursor(True)
    t.gen_typing_text("udbhav44", 3, contin=True)
    ...
    ignore_repos = []
    git_user_details = gifos.utils.fetch_github_stats("udbhav-44", ignore_repos)
    user_age = gifos.utils.calc_age(26, 10, 2004)
    t.clear_frame()
    top_languages = [lang[0] for lang in git_user_details.languages_sorted]
    user_details_lines = f"""
    \x1b[30;101mudbhav44@GitHub\x1b[0m
    --------------
    \x1b[96mOS:     \x1b[93mOSX\x1b[0m
    \x1b[96mHost:   \x1b[93mIIT Kanpur \x1b[94m#IITK\x1b[0m
    \x1b[96mKernel: \x1b[93mElectrical Engineering \x1b[94m#EE\x1b[0m
    ...
    t.gen_typing_text(" -u udbhav44", 1, contin=True)
